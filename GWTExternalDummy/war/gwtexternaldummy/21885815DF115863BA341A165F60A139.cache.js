...
var $strongName = '21885815DF115863BA341A165F60A139';
var $gwt = {};
...
var $intern_0 = 2147483647, $intern_1 = {3:1, 4:1}, $intern_2 = {3:1, 5:1, 4:1}, $intern_3 = {3:1, 163:1}, $intern_4 = {3:1}, $intern_5 = {68:1, 20:1, 3:1, 14:1, 16:1}, $intern_6 = {37:1, 3:1, 5:1, 4:1}, $intern_7 = 4194303, $intern_8 = 1048575, $intern_9 = 524288, $intern_10 = 4194304, $intern_11 = 17592186044416, $intern_12 = -9223372036854775808, $intern_13 = 65536, $intern_14 = 131072, $intern_15 = 16777216, $intern_16 = 33554432, $intern_17 = 67108864, $intern_18 = {31:1, 21:1, 26:1, 25:1, 32:1, 18:1, 13:1}, $intern_19 = {31:1, 21:1, 26:1, 25:1, 32:1, 44:1, 18:1, 13:1}, $intern_20 = {39:1}, $intern_21 = {3:1, 15:1, 55:1};
...
function $sinkEventsImpl(elem, bits){
  ...
  chMask & $intern_14 && (elem.onmousewheel = bits & $intern_14?dispatchEvent_1:null);
...
function $sinkEvents(elem, bits){
  ...
  bits & $intern_14 && elem.addEventListener('DOMMouseScroll', ($clinit_DOMImplStandard() , dispatchEvent_1), false);
}
...
defineClass(85, 84, $intern_18, Label);
...
defineClass(44, 140, $intern_19, RootPanel);
...
defineClass(141, 44, $intern_19, RootPanel$DefaultRootPanel);
...
defineClass(148, 147, $intern_18, VerticalPanel);
...
defineClass(36, 180, $intern_20, AbstractHashMap$EntrySet);
...
defineClass(70, 180, $intern_20, AbstractMap$1);
...
defineClass(7, 181, $intern_21, ArrayList);
...
defineClass(101, 181, $intern_21, Collections$EmptyList);
...
defineClass(105, 104, $intern_20, Collections$UnmodifiableMap$UnmodifiableEntrySet);
...
defineClass(119, 7, $intern_21, InternalJsHashCodeMap$InternalJsHashCodeMapLegacy$1);
...
defineClass(111, 7, $intern_21, InternalJsStringMap$InternalJsStringMapLegacy$1);
...
function CompositeDocumentEditionDummy(randomIdVars){
  ...
  this.Width > 200 && (this.Width = this.Width - 75);
  ...
  alert_0('hELLO Panel1 ' + SDocumentoS);
  JSOSucion = ($clinit_JSONParser() , dynamicCast(parse_0(SDocumentoS), 19));
  alert_0('hELLO Panel2 ' + $toString_1(JSOSucion));
...
function setContext(IdVentana, contextId, Height, isgrammar, edit, views, CompleteView){
  ...
  edit?new CompositeDocumentEditionDummy(IdVentana):new CompositeDocumentDescriptionDummy(IdVentana);
}
